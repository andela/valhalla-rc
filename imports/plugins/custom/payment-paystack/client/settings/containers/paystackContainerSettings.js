...
import { PaystackSettings } from "../components";

class PaystackContainerSettings extends Component {
  constructor(props) {
    super(props);
...
PaystackContainerSettings.propTypes = {
...
export default composeWithTracker(composer)(PaystackContainerSettings);
